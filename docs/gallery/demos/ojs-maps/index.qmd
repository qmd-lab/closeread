...
[Bertin.js](https://github.com/riatelab/bertin) is a simple mapping library. You can absolutely use it as we do in the [OJS Variables](/gallery/demos/ojs-variables/index.qmd) demo, replacing the map wholesale. But you can also use its `update()` function to change it 
...
:::{margin-aside}
The technique will work just as well with Mapbox, as well as with most frameworks that let you call code to 'update' their graphics.
:::
