...
Apply the `.scale-to-cover` class to videos to ensure that they fill up the whole Closeread sticky column (even if they need to be cropped to do it). @cr-ship

This is great for photojournalistic use cases like interviews where not every part of the frame needs to be visible. @cr-ship
