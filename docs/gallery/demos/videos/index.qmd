...
To have a video progress as we scroll, we actually need it as a sequence of images:
...
Now we'll render the sequence of images, changing the camera angle for each frame. We'll end up with 100 frames, from `image001.png` to `image100.png`:
