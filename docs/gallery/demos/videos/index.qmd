...
render_movie("rayshader.mp4",
  # use software renderer on macos
  software_render = Sys.info()['sysname'] == 'Darwin')
```
...
Here's our rayshader video! It scrolls! [@cr-rayshader]{.scroll-video}

But wait, it seems to reset on our next trigger. [@cr-rayshader]{.scroll-video}

What's up with that? [@cr-rayshader]{.scroll-video}

![](rayshader.mp4){#cr-rayshader alt="A chart of annual national statistics, animating over the 20th century."}
:::::
...
Here's our rayshader video again... @cr-rayshader-prog

::::{.progress-block focus-on="cr-rayshader-prog" .scroll-video}
...
We can use this to walk through a video more substantively.
