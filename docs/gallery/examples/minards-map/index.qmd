...
format: 
  closeread-html:
    ...
    cr-section:
      style:
        trigger-background-color-overlay: transparent
        sidebar-background-color: transparent
        section-background-color: transparent
        trigger-text-color-overlay: black
        # trigger-font-family: 'et-book, Palatino, "Palatino Linotype", "Palatino LT STD", "Book Antiqua", Georgia, serif;'
        trigger-font-family: "et-book"
---
