...
- `narrative-background-color-overlay`: the background colour used for narrative text blocks in sidebar layouts
- `narrative-text-color-overlay`: the colour of narrative text in overlay layouts
- `narrative-background-color-sidebar`: the background colour used for the narrative column in sidebar layouts
- `narrative-text-color-sidebar`: the colour of narrative text in sidebar layouts
...
- `section-background-color`: the background colour used for Closeread sections
